...
export function AboutPage({ onNavigateToCourses, onNavigateToRegister, onNavigateToCenters }: AboutPageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#EEF0FA] text-[#14162B]">
      ...
      <section className="relative bg-[#12162A] text-white py-20 px-4 sm:px-6 lg:px-8 overflow-hidden border-b border-white/10">
        ...
        <div className="max-w-5xl mx-auto relative z-10 text-center space-y-4">
          ...
          <h1 className="font-display font-black text-4xl sm:text-6xl text-white uppercase tracking-tight leading-tight">
            À Propos d'<span className="text-[#E85B3D]">ADONAI-FORMATION</span>
          </h1>
      ...
      <section className="py-20 sm:py-28 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <span className="text-xs uppercase tracking-widest font-extrabold text-[#26339E] bg-white border border-[#26339E]/20 px-3.5 py-1 rounded-full inline-block">
              Notre Mission
            </span>
            <h2 className="font-display font-black text-3xl sm:text-5xl text-[#26339E] uppercase tracking-tight leading-tight">
              Donner à Chaque Béninois un Métier <span className="text-[#E85B3D]">d'Avenir</span> et l'Autonomie Financière
            </h2>
            ...
            <div className="pt-2 flex flex-wrap gap-4">
              <button
                ...
                className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl border-2 border-[#26339E] text-[#26339E] hover:bg-[#26339E] hover:text-white text-xs font-bold uppercase tracking-wider transition-colors cursor-pointer"
              >
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl bg-[#E85B3D] hover:bg-[#D44A2D] text-white text-xs font-extrabold uppercase tracking-wider transition-colors cursor-pointer shadow-md"
              >
          ...
          <div className="lg:col-span-5">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white bg-slate-900 group">
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-md p-5 rounded-2xl border border-white/40 shadow-xl space-y-2 text-[#14162B]">
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-[#E85B3D]" />
                  <span className="text-xs font-black uppercase tracking-wider text-[#26339E]">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-3xl space-y-3 mb-16 text-left">
            ...
            <h2 className="font-display font-black text-3xl sm:text-5xl text-[#26339E] uppercase tracking-tight">
              Les 4 Piliers Fondateurs <span className="text-[#E85B3D]">d'ADONAI-FORMATION</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {pedagogiePoints.map((point, index) => {
              ...
              return (
                <div
                  key={index}
                  className="adonai-card p-8 rounded-3xl bg-white border border-slate-200 hover:border-[#E85B3D] transition-all space-y-4 relative"
                >
                  <div className="flex items-center justify-between">
                    {/* Icône dans un carré coloré sur fond lavande clair */}
                    <div className="w-14 h-14 rounded-2xl bg-[#EEF0FA] text-[#26339E] flex items-center justify-center shadow-2xs border border-[#26339E]/10">
                      <Icon className="w-7 h-7" />
                    </div>

                    <div className="flex items-center gap-2">
                      <span className="text-[11px] uppercase tracking-wider font-extrabold text-[#26339E] bg-[#EEF0FA] px-3 py-1 rounded-full">
                        {point.badge}
                      </span>
                  ...
                  <h3 className="font-display font-black text-3xl text-[#12162A] uppercase tracking-tight">
                    {point.title}
                  </h3>
      ...
      {/* 4. Chiffres clés développés en fond bleu marine quasi noir #12162A */}
      <section className="bg-[#12162A] text-white py-16 px-4 sm:px-6 lg:px-8 border-b border-white/10 relative overflow-hidden">
        {/* Motif triangles corail discret */}
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center max-w-2xl mx-auto mb-12 space-y-2">
            <span className="text-xs uppercase tracking-widest font-extrabold text-[#F5C64B]">
              Indicateurs Clés
            </span>
            <h3 className="font-display font-black text-3xl sm:text-4xl uppercase tracking-tight text-white">
              L'Impact <span className="text-[#E85B3D]">d'ADONAI-FORMATION</span>
            </h3>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 text-center">
            ...
            <div className="p-6 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/15 space-y-1">
              <div className="font-display font-black text-4xl sm:text-6xl text-[#E85B3D]">
            ...
            <div className="p-6 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/15 space-y-1">
              <div className="font-display font-black text-4xl sm:text-6xl text-[#F5C64B]">
                100%
              </div>
              <p className="text-xs uppercase tracking-wider font-extrabold text-white">
                Pratique en Atelier
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="p-8 sm:p-12 rounded-3xl bg-white border border-slate-200 shadow-sm flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="space-y-3 text-left max-w-3xl">
            ...
            <h3 className="font-display font-black text-3xl sm:text-4xl text-[#26339E] uppercase tracking-tight leading-tight">
              Des Ateliers Spacieux à <span className="text-[#E85B3D]">Porto-Novo, Cotonou et Parakou</span>
            </h3>
            <p className="text-sm text-slate-700 leading-relaxed font-normal">
          ...
          <div className="shrink-0 w-full md:w-auto">
            <button
              ...
              className="w-full md:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-[#E85B3D] hover:bg-[#D44A2D] text-white font-extrabold text-xs uppercase tracking-wider shadow-md transition-all cursor-pointer"
            >
