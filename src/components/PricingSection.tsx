...
export function PricingSection({ onApplyForScholarship, onSelectDuration }: PricingSectionProps) {
  ...
  return (
    <section id="tarifs" className="py-20 sm:py-28 bg-[#F1F7F2] relative border-b border-slate-200 overflow-hidden">
      {/* Motif graphique discret en arrière-plan (ruban diagonal or inspiré des affiches officielles ADONAI) */}
      <div 
        className="absolute inset-0 opacity-[0.04] pointer-events-none z-0"
        style={{
          backgroundImage: `repeating-linear-gradient(45deg, #2E7D32 0, #2E7D32 2px, transparent 0, transparent 24px)`
        }}
        aria-hidden="true"
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch mb-10">
          ...
          <div className="adonai-card rounded-2xl p-8 flex flex-col justify-between bg-white border border-slate-200 shadow-sm hover:shadow-md transition-all">
            <div>
              <span className="text-[11px] uppercase tracking-wider font-extrabold text-[#2E7D32] bg-slate-100 px-2.5 py-1 rounded">
                Élément 1
              </span>
              <h3 className="font-display font-black text-2xl sm:text-3xl text-[#1B4D2E] mt-3 uppercase leading-tight">
                Inscription
              </h3>
              
              <div className="mt-4 flex items-baseline gap-1">
                <span className="font-display font-black text-4xl sm:text-5xl text-[#1B4D2E] tabular-nums">
                  15 000
                </span>
              ...
              <ul className="mt-6 space-y-2.5 text-xs text-slate-600">
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-[#2E7D32] shrink-0 font-bold" />
          ...
          <div className="adonai-card rounded-2xl p-8 flex flex-col justify-between relative bg-white border-2 border-[#2E7D32] shadow-md hover:shadow-xl transition-all">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#1B4D2E] text-[#F5B800] text-[10px] uppercase tracking-wider font-extrabold px-3 py-1 rounded-full shadow-xs">
              Formule Recommandée
            </div>

            <div>
              <span className="text-[11px] uppercase tracking-wider font-extrabold text-[#2E7D32] bg-[#F1F7F2] border border-[#2E7D32]/20 px-2.5 py-1 rounded">
                Élément 2
              </span>
              <h3 className="font-display font-black text-2xl sm:text-3xl text-[#1B4D2E] mt-3 uppercase leading-tight">
                Formation 12 mois
              ...
              <div className="mt-4 flex items-baseline gap-1">
                <span className="font-display font-black text-4xl sm:text-5xl text-[#2E7D32] tabular-nums">
                  200 000
                </span>
                <span className="text-xs font-bold text-slate-500 uppercase">FCFA</span>
              </div>
              ...
              {/* Détail exact */}
              <div className="mt-4 p-3.5 rounded-xl bg-[#F1F7F2] border border-[#2E7D32]/20 text-xs text-[#1B4D2E] leading-relaxed font-medium">
            ...
            <div className="mt-8 pt-4 border-t border-slate-100">
              <button
                ...
                className="w-full py-3 rounded-xl bg-[#2E7D32] hover:bg-[#1B4D2E] text-white font-extrabold text-xs uppercase tracking-wider transition-colors cursor-pointer"
              >
          ...
          <div className="adonai-card rounded-2xl p-8 flex flex-col justify-between bg-white border border-slate-200 shadow-sm hover:shadow-md transition-all">
            ...
            <div className="mt-8 pt-4 border-t border-slate-100">
              <button
                ...
                className="w-full py-3 rounded-xl bg-slate-100 hover:bg-slate-200 text-[#1B4D2E] font-extrabold text-xs uppercase tracking-wider transition-colors cursor-pointer"
              >
        ...
        <div className="w-full rounded-2xl bg-[#F1F7F2] border-2 border-[#2E7D32]/20 p-6 sm:p-8 shadow-sm flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden">
          {/* Ruban or subtil en coin */}
          <div 
            className="absolute -right-12 -top-12 w-32 h-32 opacity-15 rotate-45 pointer-events-none bg-[#F5B800]" 
            aria-hidden="true" 
          />

          {/* Icône à gauche et texte développé à droite, disposé en ligne */}
          <div className="flex items-start gap-5 text-left">
            <div className="w-14 h-14 rounded-2xl bg-[#F5B800] text-[#1B4D2E] flex items-center justify-center shrink-0 shadow-xs mt-1">
              <Gift className="w-7 h-7" />
            </div>

            <div className="space-y-1.5 max-w-3xl">
              <div className="inline-flex items-center gap-2 bg-[#1B4D2E] text-[#F5B800] text-[10px] uppercase tracking-wider font-extrabold px-2.5 py-0.5 rounded">
                Programme Spécial Rentrée 2026
              </div>
              <h3 className="font-display font-black text-2xl sm:text-3xl text-[#1B4D2E] uppercase leading-tight">
          ...
          <div className="shrink-0 w-full md:w-auto">
            <button
              ...
              className="w-full md:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-[#1B4D2E] hover:bg-[#2E7D32] text-white font-extrabold text-xs uppercase tracking-wider shadow-sm transition-all cursor-pointer"
            >
        ...
        <div className="mt-8 text-center">
          <button
            ...
            className="inline-flex items-center gap-2 text-xs font-semibold text-[#2E7D32] hover:text-[#1B4D2E] underline cursor-pointer"
          >
        ...
        {showSimulator && (
          <div className="mt-6 bg-white rounded-2xl p-6 sm:p-8 max-w-2xl mx-auto border border-slate-200 shadow-md">
            <h4 className="font-display font-black text-2xl text-[#1B4D2E] uppercase mb-2">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <button
                  ...
                  className={`w-full py-2.5 px-4 text-xs font-bold rounded-lg border transition-all flex items-center justify-between cursor-pointer ${
                    simScholarship
                      ? 'bg-[#F1F7F2] text-[#1B4D2E] border-[#2E7D32]/20'
                      : 'bg-white text-slate-700 border-slate-200'
                  }`}
                >
              ...
              <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2 text-xs">
                <div className="flex justify-between font-bold text-sm text-[#1B4D2E] pb-2 border-b border-slate-200">
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full p-6 text-left flex items-center justify-between gap-4 font-bold text-[#1B4D2E] hover:text-[#2E7D32] transition-colors cursor-pointer"
                  >
                    ...
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 transition-transform duration-300 ${
                      isOpen ? 'rotate-180 bg-[#1B4D2E] text-[#F5B800]' : 'bg-slate-100 text-slate-600'
                    }`}>
                  ...
                  {isOpen && (
                    <div className="px-6 pb-6 pt-1 text-xs sm:text-sm text-slate-600 leading-relaxed border-t border-slate-100 space-y-2">
                      <p>{item.answer}</p>
                      {item.note && (
                        <p className="text-[11px] text-[#2E7D32] font-semibold italic bg-slate-50 p-2.5 rounded-lg border border-slate-200">
                          {item.note}
                        </p>
                      )}
                    </div>
