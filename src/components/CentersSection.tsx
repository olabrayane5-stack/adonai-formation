...
export function CentersSection({ onSelectCenter }: CentersSectionProps) {
  return (
    <section id="centres" className="py-20 sm:py-28 bg-[#F8FAF8] relative border-b border-slate-200 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch mb-16">
          ...
          {/* CARTE 1 : PORTO-NOVO */}
          <div className="adonai-card rounded-3xl overflow-hidden flex flex-col justify-between relative bg-white border-2 border-[#124B30] shadow-md hover:shadow-xl transition-all group">
            ...
            <div className="relative h-52 w-full overflow-hidden bg-slate-900">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0B2B1B] via-[#0B2B1B]/60 to-transparent" />
              
              <div className="absolute top-3.5 left-3.5 bg-[#124B30] text-[#E5A910] text-[10px] font-extrabold uppercase tracking-wider px-3 py-1 rounded-full border border-[#E5A910]/40 shadow-xs">
              ...
              <div className="absolute bottom-3.5 left-4 right-4 text-white">
                ...
                <p className="text-xs text-[#E5A910] font-semibold mt-0.5">
            ...
            <div className="p-6 sm:p-7 flex-1 flex flex-col justify-between space-y-4">
              <div className="space-y-3.5">
                ...
                <div className="p-3 rounded-xl bg-slate-50 border border-slate-200 text-xs text-slate-800 flex items-start gap-2.5">
                  <MapPin className="w-4 h-4 text-[#E5A910] shrink-0 mt-0.5" />
                  <div>
                    <span className="font-bold text-[#0B2B1B]">Kandévié, carrefour Yaya gendarme</span>
                ...
                <div className="text-xs text-slate-700 leading-relaxed space-y-2">
                  ...
                  <div className="pt-1">
                    <span className="text-[11px] uppercase tracking-wider font-extrabold text-[#124B30] block mb-1.5">
                      Filières disponibles sur place :
                    </span>
                    <div className="flex flex-wrap gap-1.5 text-[11px]">
                      <span className="bg-[#FEF8E8] text-[#0B2B1B] px-2 py-0.5 rounded border border-[#F7D479]">Haute couture</span>
                      <span className="bg-[#FEF8E8] text-[#0B2B1B] px-2 py-0.5 rounded border border-[#F7D479]">Électricité</span>
                      <span className="bg-[#FEF8E8] text-[#0B2B1B] px-2 py-0.5 rounded border border-[#F7D479]">Plomberie</span>
                      <span className="bg-[#FEF8E8] text-[#0B2B1B] px-2 py-0.5 rounded border border-[#F7D479]">Froid</span>
                      <span className="bg-[#FEF8E8] text-[#0B2B1B] px-2 py-0.5 rounded border border-[#F7D479]">Santé & Info</span>
                    </div>
                  </div>
                ...
                <div className="pt-3 border-t border-slate-100 space-y-2 text-xs text-slate-600">
                  <div className="flex items-center gap-2">
                    <Phone className="w-3.5 h-3.5 text-[#124B30] shrink-0" />
                    <span>Ligne directe : <strong className="text-[#0B2B1B]">01 66 73 06 67</strong></span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Clock className="w-3.5 h-3.5 text-[#124B30] shrink-0" />
              ...
              <div className="pt-4 border-t border-slate-100 flex flex-col gap-2">
                <button
                  ...
                  className="w-full py-2.5 px-4 rounded-xl bg-[#0B2B1B] hover:bg-[#124B30] text-white text-xs font-bold uppercase tracking-wider transition-colors flex items-center justify-center gap-1.5 cursor-pointer"
                >
                  <span>S'inscrire à Porto-Novo</span>
                  <ArrowRight className="w-4 h-4 text-[#E5A910]" />
                </button>
                <a
                  href={`tel:0166730667`}
                  className="w-full py-2 text-center text-xs font-semibold text-[#124B30] hover:underline"
                >
          ...
          <div className="adonai-card rounded-3xl overflow-hidden flex flex-col justify-between relative bg-white border border-slate-200 shadow-sm hover:shadow-xl transition-all group">
            ...
            <div className="relative h-52 w-full overflow-hidden bg-slate-900">
              ...
              <div className="absolute top-3.5 left-3.5 bg-white/90 backdrop-blur-sm text-[#0B2B1B] text-[10px] font-extrabold uppercase tracking-wider px-3 py-1 rounded-full shadow-xs">
                Antenne Économique
              </div>
            ...
            <div className="p-6 sm:p-7 flex-1 flex flex-col justify-between space-y-4">
              <div className="space-y-3.5">
                ...
                <div className="p-3 rounded-xl bg-slate-50 border border-slate-200 text-xs text-slate-800 flex items-start gap-2.5">
                  <MapPin className="w-4 h-4 text-[#E5A910] shrink-0 mt-0.5" />
                  <div>
                    <span className="font-bold text-[#0B2B1B]">Cotonou Métropole</span>
                ...
                <div className="pt-3 border-t border-slate-100 space-y-2 text-xs text-slate-600">
                  <div className="flex items-center gap-2">
                    <Phone className="w-3.5 h-3.5 text-[#124B30] shrink-0" />
                    <span>Ligne directe : <strong className="text-[#0B2B1B]">01 66 48 58 67</strong></span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Clock className="w-3.5 h-3.5 text-[#124B30] shrink-0" />
              ...
              <div className="pt-4 border-t border-slate-100 flex flex-col gap-2">
                <button
                  ...
                  className="w-full py-2.5 px-4 rounded-xl border border-slate-300 hover:bg-slate-100 text-[#0B2B1B] text-xs font-bold uppercase tracking-wider transition-colors flex items-center justify-center gap-1.5 cursor-pointer"
                >
                  <span>S'inscrire à Cotonou</span>
                  <ArrowRight className="w-4 h-4 text-[#124B30]" />
                </button>
                <a
                  href={`tel:0166485867`}
                  className="w-full py-2 text-center text-xs font-semibold text-[#124B30] hover:underline"
            ...
            <div className="p-6 sm:p-7 flex-1 flex flex-col justify-between space-y-4">
              <div className="space-y-3.5">
                ...
                <div className="p-3 rounded-xl bg-slate-50 border border-slate-200 text-xs text-slate-800 flex items-start gap-2.5">
                  <MapPin className="w-4 h-4 text-[#E5A910] shrink-0 mt-0.5" />
                  <div>
                    <span className="font-bold text-[#0B2B1B]">Parakou Grand Nord</span>
                ...
                <div className="pt-3 border-t border-slate-100 space-y-2 text-xs text-slate-600">
                  <div className="flex items-center gap-2">
                    <Phone className="w-3.5 h-3.5 text-[#124B30] shrink-0" />
                    <span>Ligne directe : <strong className="text-[#0B2B1B]">01 53 51 95 43</strong></span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Clock className="w-3.5 h-3.5 text-[#124B30] shrink-0" />
        ...
        <div className="rounded-3xl bg-white border border-slate-200 p-8 sm:p-10 shadow-sm space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="space-y-1">
              ...
              <h3 className="font-display font-black text-2xl sm:text-3xl text-[#0B2B1B] uppercase tracking-tight">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-slate-100 hover:bg-slate-200 text-[#0B2B1B] font-bold text-xs uppercase tracking-wider transition-colors cursor-pointer self-start md:self-auto border border-slate-300"
            >
              <Navigation className="w-4 h-4 text-[#124B30]" />
        ...
        <div className="mt-14 p-5 rounded-2xl bg-white border border-slate-200 text-center text-xs text-slate-600 space-y-1">
          <p>
            ...
            <a href={`tel:${GENERAL_CONTACT.primaryPhone}`} className="font-bold text-[#0B2B1B] underline hover:text-[#124B30]">
          ...
          <p className="text-slate-500">
            Email officiel :{' '}
            <a href={`mailto:${GENERAL_CONTACT.email}`} className="font-bold text-[#0B2B1B] underline hover:text-[#124B30]">
