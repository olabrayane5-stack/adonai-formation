...
Merci de m'indiquer la confirmation de mon inscription et le créneau pour déposer mes photos et mon acte de naissance.`;
  ...
  return (
    <section id="inscription" className="py-20 sm:py-28 bg-gradient-to-br from-[#061D12] via-[#0B2B1B] to-[#124B30] text-white relative border-b border-white/10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-3 mb-12">
          <span className="text-xs uppercase tracking-widest font-extrabold text-[#E5A910] bg-white/10 border border-white/15 px-3.5 py-1 rounded-full inline-block">
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-white/10 border border-white/15 backdrop-blur-sm rounded-2xl p-5 relative">
              <span className="w-7 h-7 rounded-full bg-[#E5A910] text-[#0B2B1B] font-display font-black text-sm flex items-center justify-center mb-3">
                1
              </span>
          ...
          {submittedApp ? (
            ...
            <div className="bg-white text-slate-900 rounded-3xl p-8 sm:p-10 shadow-2xl space-y-6">
              ...
              <div className="space-y-2 text-xs sm:text-sm border-t border-b border-slate-100 py-4 text-slate-700">
                ...
                <div className="flex justify-between py-1">
                  ...
                  <strong className="text-[#124B30]">{submittedApp.filiere}</strong>
                </div>
                <div className="flex justify-between py-1">
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 pt-2 no-print">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <a
                    ...
                    className="px-5 py-2.5 rounded-lg bg-[#E5A910] hover:bg-[#C98F04] text-[#0B2B1B] text-xs font-extrabold uppercase tracking-wider cursor-pointer"
                  >
                    Ouvrir WhatsApp
                  </a>
                </div>
            ...
            <div className="bg-white text-slate-900 rounded-3xl p-8 sm:p-10 shadow-2xl">
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 text-xs sm:text-sm bg-slate-50 border rounded-xl focus:outline-none focus:border-[#E5A910] ${
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 text-xs sm:text-sm bg-slate-50 border border-slate-300 rounded-xl focus:outline-none focus:border-[#E5A910]"
                    >
                      {FILIERES_DATA.map((f) => (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <label
                      className={`p-3.5 rounded-xl border-2 flex items-center gap-3 cursor-pointer transition-all ${
                        duration === '12 mois'
                          ? 'border-[#124B30] bg-[#FEF8E8] text-[#0B2B1B]'
                    ...
                    >
                      <input
                        ...
                        className="w-4 h-4 text-[#124B30] focus:ring-[#124B30]"
                      />
                      <div>
                ...
                <div className="p-3.5 rounded-xl bg-[#FEF8E8] border border-[#F7D479] flex items-start gap-3">
                  <input
                    type="checkbox"
                    id="scholarshipCheckbox"
                    checked={applyScholarship}
                    onChange={(e) => setApplyScholarship(e.target.checked)}
                    className="w-4 h-4 mt-0.5 rounded text-[#E5A910] focus:ring-[#E5A910] cursor-pointer"
                  />
                ...
                <div className="pt-2">
                  <button
                    type="submit"
                    className="w-full py-4 px-6 rounded-xl bg-[#E5A910] hover:bg-[#C98F04] text-[#0B2B1B] font-extrabold text-sm uppercase tracking-wider flex items-center justify-center gap-2.5 shadow-lg transition-all cursor-pointer"
                  >
        ...
        <div className="mt-12 text-center text-xs text-white/70 space-y-1">
          ...
          <p className="font-semibold text-white">
            ...
            <a href={`tel:${GENERAL_CONTACT.primaryPhone}`} className="text-[#E5A910] underline">
              {GENERAL_CONTACT.primaryPhone}
            </a>
            {' '}ou au{' '}
            <a href="tel:0166485867" className="text-[#E5A910] underline">
              01 66 48 58 67
            </a>
          </p>
        </div>
