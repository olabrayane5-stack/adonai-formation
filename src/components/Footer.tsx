        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 pb-12 border-b border-white/10 items-start">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-[#F5B800] shrink-0 bg-white p-0.5">
                <img
            ...
            <p className="text-xs text-[#F5B800] font-semibold italic border-l-2 border-[#F5B800] pl-2.5">
          ...
          <div className="space-y-3">
            <h4 className="text-xs font-bold uppercase tracking-widest text-[#F5B800]">
              Navigation
            </h4>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2.5 text-xs sm:text-sm text-white/80">
              <div className="flex items-start gap-2">
                ...
                <a href={`mailto:${GENERAL_CONTACT.email}`} className="hover:text-[#F5B800] underline">
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between text-xs text-white/60 gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <ArrowUp className="w-3.5 h-3.5 text-[#F5B800]" />
            </button>
          </div>
        </div>
