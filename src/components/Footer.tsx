...
export function Footer({ onNavigate }: FooterProps) {
  ...
  return (
    <footer className="bg-[#0B2B1B] text-white pt-16 pb-10 border-t border-white/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 pb-12 border-b border-white/10 items-start">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-[#E5A910] shrink-0 bg-white p-0.5">
                <img
              ...
              <div>
                <span className="font-display font-black text-2xl text-white tracking-tight leading-none block uppercase">
                  ADONAI<span className="text-[#E5A910] ml-1">FORMATION</span>
                </span>
            ...
            <p className="text-xs text-[#E5A910] font-semibold italic border-l-2 border-[#E5A910] pl-2.5">
          ...
          <div className="space-y-3">
            <h4 className="text-xs font-bold uppercase tracking-widest text-[#E5A910]">
              Navigation
            </h4>
            <ul className="space-y-2 text-xs sm:text-sm text-white/80">
              <li>
                <button
                  ...
                  className="hover:text-[#E5A910] transition-colors cursor-pointer text-left"
                >
                  Accueil
                </button>
              </li>
              ...
              <li>
                <button
                  ...
                  className="text-[#E5A910] font-bold hover:underline transition-colors cursor-pointer text-left"
                >
                  Contact / Inscription
                </button>
              </li>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2.5 text-xs sm:text-sm text-white/80">
              <div className="flex items-start gap-2">
                <Mail className="w-4 h-4 text-[#E5A910] shrink-0 mt-0.5" />
                <a href={`mailto:${GENERAL_CONTACT.email}`} className="hover:text-[#E5A910] underline">
                  {GENERAL_CONTACT.email}
                </a>
              </div>

              <div className="flex items-start gap-2">
                <Phone className="w-4 h-4 text-[#E5A910] shrink-0 mt-0.5" />
                <div className="space-y-0.5">
                  <a href="tel:0166730667" className="block hover:text-[#E5A910]">01 66 73 06 67</a>
                  <a href="tel:0166485867" className="block hover:text-[#E5A910]">01 66 48 58 67</a>
                  <a href="tel:0153519543" className="block hover:text-[#E5A910]">01 53 51 95 43</a>
                </div>
              </div>
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between text-xs text-white/60 gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <ArrowUp className="w-3.5 h-3.5 text-[#E5A910]" />
            </button>
          </div>
        </div>
